...
var ACCESSTOKEN_CREATION = API_ROOT + '/oauth/authorize/';
...
module.exports = function(appId, appSecret) {
  ...
  */
  ...
  this.getAccessToken = function(code, cb) {
    request.get(ACCESSTOKEN_CREATION, + code, function(err, resp) {
      self._requireNoErr(err);
  ...
  this.sendDocument = function(datas, cb) {
    ...
    if(!datas.identifier) {
      throw new Error("Datas must include an identifier.");
    }

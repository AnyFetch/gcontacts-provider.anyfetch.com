...
var connectAccountRetrieveAuthDatas = function(req, preDatas, next) {
  ...
  oauth2Client.getToken(req.params.code, function(err, tokens) {
    ...
    if(!tokens.refresh_token) {
      return next(new Error("You're already subscribed to Cluestr Google Contacts. To subscribe again, please revoke the permission from your Google Account."));
    }
